      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
          <div class="flex items-center">
            <UIcon name="i-heroicons-arrows-right-left" class="w-8 h-8 text-amber-600 dark:text-amber-400" />
            ...
            <UCard>
              ...
              <nav class="space-y-2">
                ...
                <UButton
                  ...
                  class="w-full justify-start bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-300 hover:bg-amber-200 dark:hover:bg-amber-900/50"
                >
                  {{ $t('docs.sections.integration') }}
                </UButton>
                <UButton
...
const seoTitle = computed(() => `${t('docs.sections.integration')} | Matrix Protocol`)
const seoDescription = computed(() => t('docs.integration.description'))
