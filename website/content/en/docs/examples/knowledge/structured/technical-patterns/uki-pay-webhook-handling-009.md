...
description: "Wrapper page for YAML asset uki-pay-webhook-handling-009.yaml"
layout: "docs"
sidebar: true
toc: true
navigation: true
...
> Source YAML: `en/docs/examples/knowledge/structured/technical-patterns/uki-pay-webhook-handling-009.yaml`
...
title: "Gateway Webhook Processing Pattern"
version: 2.1.0
created_date: 2024-03-25
last_modified: 2024-03-25
change_summary: "Implementation of deduplication and signature validation based on production issues"
change_impact: major
...
content: |
  ...
  **Processing:** Async with queue for reliability
  **Persistence:** Complete log for audit and debug
  
  ## Deduplication (Anti-Double Processing)
...
examples:
  ...
  - input: "PayPal webhook: invalid signature, valid transaction"
...
related_to:
  - target: uki:squad-payments:technical_pattern:gateway-integration-007
    type: complements
    description: "Webhooks complement synchronous integration for asynchronous confirmation"
  - target: uki:squad-payments:technical_pattern:idempotency-keys-011
    type: relates_to
    description: "Webhook deduplication uses similar idempotency concepts"
  - target: uki:squad-payments:procedure:incident-response-014
    type: relates_to
    description: "Critical webhook failures follow incident response process"
